            ...
            <SplashContainer>
                ...
                <div className="inner">
                    ...
                    <PromoSection>
                        ...
                        <Button
                            href="https://gerencianet.com.br/login"
                            target="_blank"
                        >
                            ACESSAR MINHA CONTA
                        </Button>
        ...
        const Apresentacao = () => (
            <Block background="light">
                {[
                    {
                        content:
                            '<p align="left" class="corpo">Tudo o que você precisa em serviços de <strong>pagamentos</strong>. Aqui você encontra as documentações necessárias para integrar com as APIs, Bibliotecas e Módulos da <strong>API de Integrações Gerencianet</strong>.<br/></p>',
        ...
        const TryOut = () => (
            <Block>
                {[
                    {
                        title:
                            '<div class="sub-titulo"><b>Simplifique</b> as suas cobranças com a API Gerencianet<br/><br/></div>',
                        content:
                            '<div class="container"><div class="row"><div class="col-lg-10 col-12 mx-md-auto "><div class="embed-responsive embed-responsive-16by9 aos-animate" data-aos="fadeInUp"><iframe width="560" height="315" data-lazy="" data-src="https://www.youtube.com/embed/VrCmvnqZ0S4?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube.com/embed/VrCmvnqZ0S4?rel=0" data-loaded="true"></iframe></div></div></div></div><br/><br/>',
                        imageAlign: "center"
                    }
                ]}
            </Block>
            ...
            return (
                <div className="productShowcaseSection paddingBottom">
                    ...
                    <h1 className="sub-titulo">
                        <br />
                        <br />
                        FACILITE A SUA INTEGRAÇÃO COM AS NOSSAS SDKS
                    </h1>
                    <br />
                    <div align="center" className="corpo">
                        Confira nossa documentação e{" "}
                        <strong>integre de forma facilitada</strong>
                    </div>
                    <br />
                    <br />
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-dotnet"
                        target="_blank"
                        title="C# .NET"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-go"
                        target="_blank"
                        title="Golang"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-java"
                        target="_blank"
                        title="Java"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-python"
                        target="_blank"
                        title="Python"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-ruby"
                        target="_blank"
                        title="Ruby"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-php"
                        target="_blank"
                        title="PHP"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-node"
                        target="_blank"
                        title="NodeJS"
                    >
                    ...
                    <a
                        className="productShowcaseSection paddingBottom"
                        href="https://github.com/gerencianet/gn-api-sdk-delphi"
                        target="_blank"
                        title="Delphi"
                    >
